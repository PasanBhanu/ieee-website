...
<head>
    ...
    <title>Chapters of IEEE SB UoM - IEEE University of Moratuwa Student Branch</title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level">
                        <h4 class="title"> Chapters of IEEE SB UoM </h4>
                        <ul class="page-next d-inline-block bg-white shadow p-2 pl-4 pr-4 rounded mb-0">
                            ...
                            <li>
                                <span class="text-uppercase text-primary font-weight-bold">Chapters</span>
                            </li>
                        </ul>
                    </div>
                </div>
