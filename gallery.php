...
<head>
    ...
    <title>Gallery - IEEE University of Moratuwa Student Branch</title>

    <meta name="description" content="How to become an IEEE member. Read our guide and watch video tutorials." />
                ...
                <div class="col-lg-12 text-center">
                    <div class="page-next-level">
                        ...
                        <ul class="page-next d-inline-block bg-white shadow p-2 pl-4 pr-4 rounded mb-0">
                            ...
                            <li>
                                <span class="text-uppercase text-primary font-weight-bold">Gallery</span>
                            </li>
                        </ul>
                    </div>
                </div>
